            ...
            <div class="col-12 p-0">
                <div class="login-card">
                    <form class="theme-form login-form" method="post" action="{{ route('register') }}">
                        ...
                        <h4><strong>Crie sua conta</strong></h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="small-group">
                                <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                                    <input class="form-control @error('name') is-invalid @enderror"  type="text" required="" placeholder="First name" name="name" :value="old('name)">
                                    @error('name')
                                    <div class="show-hide">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                                <input class="form-control @error('email') is-invalid @enderror"  type="email" placeholder="Test@gmail.com" name="email" required="">
                                @error('email')
                                <div class="show-hide">
                                    <span class="show" role="alert">
                                        <strong>{{$message}}</strong>
...
{{--                                </ul>--}}
{{--                            </div>--}}
                            <p>Já está registado?<a class="ms-2" href="/login">Iniciar sessão</a></p>
                    </form>
                </div>
            </div>
        </div>
